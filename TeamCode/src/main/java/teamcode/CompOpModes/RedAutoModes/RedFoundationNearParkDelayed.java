...
//
//@Autonomous(name = "RedFoundationNearParkDelayed")
//
//public class RedFoundationNearParkDelayed extends LinearOpMode {
//
...
//        //r.followTrajectorySync(r.trajectoryBuilder().reverse().splineTo(new Pose2d(-27,-40,Math.toRadians(90))).build());
//
//    }
//
