...
//
//@Autonomous(name = "BlueFoundationNearPark")
//
//public class BlueFoundationNearPark extends LinearOpMode {
//
...
//       // r.followTrajectorySync(r.trajectoryBuilder().reverse().splineTo(new Pose2d(-25.5,40,Math.toRadians(-90))).build());
//
//    }
//
